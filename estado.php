        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="text-center">Vacunas solicitadas </h1>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#insertar"> Solicitar </button>
                    <br><br>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php include_once("consultas/consultarpedido.php");?>
                            <?php while($array = mysqli_fetch_array($query)) {
                                ?>
                                <tr>
                                    <td><?php echo $array['ped_id']?></td>
                                    <td><?php echo $array['vac_id']?></td>
                                    <td><?php echo $array['punto_id']?></td>
                                    <td><?php echo $array['fecha_ped']?></td>
                                    <td><?php echo $array['cantidad_ped']?></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Rellene los datos para solicitar lote de vacuna: </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="consultas/crearPedido.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date"  name="fechaPedido" readonly onmousedown="return false;" class="form-control" value="<?php echo date("Y-m-d"); ?>">
                                            </div>
