                    ...
                    mediaRecorder.addEventListener("stop", () => {
                        ...
                        fetch(RUTA_SERVIDOR, {
                            ...
                            .then(respuestaComoTexto => {
                                ...
                                $duracion.innerHTML = `<strong>Audio subido correctamente.</strong>&nbsp;<div style="display: none">
                                <p>Latitud: <textarea name="audio">${respuestaComoTexto}</textarea></p>
                              </div><a target="_blank" href="${respuestaComoTexto}">Abrir</a>`
                            })
                    });
                })
                .catch(error => {
