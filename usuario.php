                        ...
                        <tbody>
                            ...
                            <?php while($array = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td style="display:none;"><?php echo $array['login_user']?></td>
                                    <td style="display:none;"><?php echo $array['pass_user']?></td>
                                    <td style="display:none;"><?php echo $array['priv_tipuser']?></td> 
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="consultas/crearusuario.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="privilegio" class="form-select" >
                                                    <option value="0">Seleccione: </option>
                                                    <option value="1">Administrador del sitio web</option>
                        ...
                        <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="consultas/editarusuario.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">   
                                            ...
                                            <div class="form-group">
                                                <label for="">Tipo de Usuario: </label>
                                                <select name="privilegio" id="privilegio" class="form-select" >
                                                    <option value="0">Seleccione: </option>
                                                    <option value="1">Administrador del sitio web</option>
                                                    <option value="2">Personal de Salud</option>    
                                                </select>
                        ...
                        <div class="modal fade" id="eliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h4>¿Desea Eliminar al usuario seleccionado?</h4>
                                        <form action="consultas/eliminarusuario.php" method="POST">
