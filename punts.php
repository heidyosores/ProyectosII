...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="administrador.php">
                ...
                <div class="sidebar-brand-text mx-3">Gestión de Vacunas</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="tarjeta.php">
                    <i class="fas fa-fw fa-list"></i>
                    <span>Generar Tarjeta de Vacunación</span>
                </a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="text-center">Listado de Puntos de Vacunación</h1>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php while($array = mysqli_fetch_array($query)) {
                                ?>
                                <tr>
                                    <td><?php echo $array['id_pvac']?></td>
                                    <td><?php echo $array['nom_pvac']?></td>
                                    <td><?php echo $array['lat_pvac']?></td>
                                    <td><?php echo $array['lng_pvac']?></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Nuevo ingreso de Punto de Vacunación</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="./consultas/crearpunto.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="">Nombre Punto de Vacunación: </label>
                                                <input type="text" name="nombre" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Latitud: </label>
                                                <input type="text" name="latitud" class="form-control" id="input_latitud">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Longitud: </label>
                                                <input type="text" name="longitud" class="form-control" id="input_longitud">
                                            </div>
    ...
    <script>
        ...
        function iniciarMap() {
            var myLatLng = { lat: -12.068362906966614, lng: -75.21032968963519 };
        ...
        $("#insertar").on("shown.bs.modal",function(){
            var map = new window.google.maps.Map(document.getElementById("map"), window.mapProp);
             // Limpiar otros marcadores
            map.setOptions({ styles: window.styles["hide"] });
            map.addListener("click", function(t){
                var ncor = t.latLng.toJSON();
                var marker = new window.google.maps.Marker({
                position: ncor, // latitud
                map: map, //instancia
                //icon: _icon, // icono
                //title: _name // el titulo
                });
                $("#input_latitud").val(ncor["lat"]);
                $("#input_longitud").val(ncor["lng"]);
            });
