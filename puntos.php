                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="">Seleccione el nuevo punto de vacunación: </label>
                                        ...
                                        <form action="consultas/crearpunto.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly onmousedown="return false;" name="latitud" class="form-control" id="input_latitud">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Longitud: </label>
                                                <input type="text" readonly onmousedown="return false;" name="longitud" class="form-control" id="input_longitud">
                                            </div>
