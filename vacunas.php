            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php include_once("consultas/consultarvacuna.php");?>
                            <?php while($array = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    <td><?php echo $array['id_stvac']?></td>
                                    <td style="display:none;"><?php echo $array['vac_id']?></td>
                                    <td><?php echo $val['nom_vac']?></td>
                                    <td><?php echo $array['lote_stvac']?></td>
                                    <td style="display:none;"><?php echo $array['cantidad_stvac']?></td>
                                    <td><?php echo $array['stock_stvac']?></td>
                                    <td style="display:none;"><?php echo $array['punto_id']?></td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="consultas/crearstockvacuna.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">   
                                                <input type="hidden" name="id"  class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Punto de Vacunación: </label>
                                                <select name="punto" class="form-select" >
                                                    <option value="0">Seleccione: </option>
                                                        <?php include_once("consultas/consultarpuntos.php"); ?>
                                                        <?php
                                                            while ($valores = mysqli_fetch_array($query)) {
                                                            echo '<option value="'.$valores['id_pvac'].'">'.$valores['nom_pvac'].'</option>';
                                                            }
                                                        ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="vacuna" class="form-select" >
                                                    <option value="0">Seleccione: </option>
                                                        <?php include_once("consultas/consultarnomvacuna.php"); ?>
                                                        <?php
                                                            while ($valores = mysqli_fetch_array($query)) {
                                                            echo '<option value="'.$valores['id_vac'].'">'.$valores['nom_vac'].'</option>';
                                                            }
                                                        ?>
                                                </select>
                                            </div>
                        ...
                        <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Editar ingreso de vacuna</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="consultas/editarstockvacuna.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">   
                                            ...
                                            <div class="form-group">
                                                <label for="">Punto de Vacunación: </label>
                                                <select name="punto"  id="punt" class="form-select" >
                                                    <option value="0">Seleccione: </option>
                                                        <?php include_once("consultas/consultarpuntos1.php"); ?>
                                                        <?php
                                                            while ($valores = mysqli_fetch_array($query)) {
                                                            echo '<option value="'.$valores['id_pvac'].'">'.$valores['nom_pvac'].'</option>';
                                                            }
                                            ...
                                            <div class="form-group">
                                                <label for="">Vacuna: </label>
                                                <select name="vacuna" id="vac" class="form-select" >
                                                    <option value="0">Seleccione: </option>
                                                        <?php include_once("consultas/consultarnomvacuna1.php"); ?>
                                                        <?php
                                                            while ($valores = mysqli_fetch_array($query)) {
                                                            echo '<option value="'.$valores['id_vac'].'">'.$valores['nom_vac'].'</option>';
                                                            }
                                            ...
                                            <div class="form-group">
                                                <label for="">Lote: </label>
                                                <input type="text" name="lote" id="lot" class="form-control">
                                            </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="consultas/eliminarstockvacuna.php" method="POST">
